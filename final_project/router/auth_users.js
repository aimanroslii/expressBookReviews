...
regd_users.delete("/auth/review/:isbn", (req,res)=> {
  ...
  if(bookReviewToDelete.hasOwnProperty(username)) {
    ...
    return res.json({message: "You havent reviewed this book yet."})
  }
});
...
/**
 * 
 * https://github.com/Abdullah-Maqbool/expressBookReviews/blob/main/final_project/router/auth_users.js
 * 
 */